...
(function($){
	$.fn.SinaEmotion = function(target){
		...
		$(this).click(function(event){
			...
			var eTop = target.offset().top + target.height() + 18;
			...
			$('#emotions').html('<div style="float:right"><a href="javascript:void(0);" id="prev">&laquo;</a><a href="javascript:void(0);" id="next">&raquo;</a></div><div class="categorys"></div><div class="containersina"></div><div class="page"></div>');
		...
		function showEmotions(){
			...
			for(var i = page * 72; i < (page + 1) * 72 && i < emotions[category].length; ++i){
                $('#emotions .containersina').append($('<a href="javascript:void(0);" title="' + emotions[category][i].name + '" ><img src="' + emotions[category][i].icon + '" alt="' + emotions[category][i].name + '" width="22px" height="22px" /></a>'));
			}
