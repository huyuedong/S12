...
class WebGroup(models.Model):
	...
	admins = models.ManyToManyField(UserProfile, blank=True, null=True, related_name="group_admins", verbose_name=u"管理员")
	members = models.ManyToManyField(UserProfile, blank=True, null=True, related_name="group_members", verbose_name=u"群成员")
